...
/// `TextAsyncButton`, `IconAsyncButton`, and `FloatingActionAsyncButton` for
/// the named-constructor variants. Use `AsyncButton` when you need a custom
/// non-Material button.
library;
...
part 'src/buttons/floating_action_async_button.dart';
